...
def create_all_windings(design):
    ...
    points1 = points1 + [[points1[-1][0], f"-({points1[-1][1]})", points1[-1][2]]]
    ...
    first_point = points1[0].copy()
    first_point[0] = "w1/2 + 400mm"
    last_point = points1[-1].copy() 
    last_point[0] = "w1/2 + 400mm"
    points1 = [first_point] + points1 + [last_point]
    ...
    points2 = points2 + [[points2[-1][0], f"-({points2[-1][1]})", points2[-1][2]]]
    points2 = points2 + [["w1/2 + 400mm", points2[-1][1], points2[-1][2]]]
    points2 = [["w1/2 + 400mm", points2[0][1], points2[0][2]]] + points2
    ...
    points3 = points3 + [[points3[-1][0], f"-({points3[-1][1]})", points3[-1][2]]]
    points3 = points3 + [["w1/2 + 400mm", points3[-1][1], points3[-1][2]]]
    points3 = [["w1/2 + 400mm", points3[0][1], points3[0][2]]] + points3
