...
def create_input_parameter(design, param_list=None):
    ...
    N2_space_w = design.get_random_value(lower=3, upper=50, resolution=0.1)
    N2_space_l = design.get_random_value(lower=3, upper=50, resolution=0.1)
    ...
    offset_ratio_center = design.get_random_value(lower=0.05, upper=0.95, resolution=0.01)
    offset_ratio_sub = design.get_random_value(lower=-0.95, upper=0.95, resolution=0.01)
...
def set_design_variables(design, input_parameter):
    ...
    """
    units = {
        "w1": "mm", "l1_top": "mm", "l1_center": "mm", "l1_side": "mm", "l2": "mm", "h1": "mm", "h1_gap": "mm", "h2_gap": "mm", "h3_gap": "mm",
