...
def get_maxwell_magnetic_parameter(design, dir=None, mod="write", import_report=None):
    ...
    params = [
        ...
        ["Matrix.L(Rx1_Winding,Rx1_Winding)", f"LRx1", "uH"],
        ["Matrix.L(Rx2_Winding,Rx2_Winding)", f"LRx2", "uH"],
        ["Matrix.L(Tx_Winding,Rx1_Winding)", f"M1", "uH"],
        ["Matrix.L(Tx_Winding,Rx2_Winding)", f"M2", "uH"],
        ["Matrix.L(Rx_Winding1,Rx_Winding2)", f"M3", "uH"],
        ["abs(Matrix.CplCoef(Tx_Winding,Rx1_Winding))", f"k1", ""],
        ["abs(Matrix.CplCoef(Tx_Winding,Rx2_Winding))", f"k2", ""],
        ["abs(Matrix.CplCoef(Rx1_Winding,Rx2_Winding))", f"k3", ""],
        ...
        ["Matrix.L(Tx_Winding,Tx_Winding)*((1-abs(Matrix.CplCoef(Tx_Winding,Rx1_Winding))^2)+(1-abs(Matrix.CplCoef(Tx_Winding,Rx2_Winding))^2))", f"Llt", "uH"],
        ["Matrix.L(Rx1_Winding,Rx1_Winding)*((1-abs(Matrix.CplCoef(Rx1_Winding,Tx_Winding))^2)+(1-abs(Matrix.CplCoef(Rx1_Winding,Rx2_Winding))^2))", f"Llr1", "uH"],
        ["Matrix.L(Rx2_Winding,Rx2_Winding)*((1-abs(Matrix.CplCoef(Rx2_Winding,Tx_Winding))^2)+(1-abs(Matrix.CplCoef(Rx2_Winding,Rx1_Winding))^2))", f"Llr2", "uH"],
    ]
